...
| [ADR 目录](./adr/) | 架构决策记录（无依赖 REPL 输入历史 ADR-0001、TUI 前端 ADR-0003、前端无关渲染 seam ADR-0004、`/` 补全弹框 ADR-0005、TUI 显示对齐 pi ADR-0006、TUI 第二轮对齐 pi（无边框编辑器/嵌入状态/弹框上移）ADR-0007、会话按项目分区 + 配额清理 ADR-0008 等） |
